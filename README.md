...
This project does not seek to assign blame or take a political position. Our focus is entirely humanitarian: to strengthen evidence-based planning for care delivery under extreme conditions.
...
- **cumulative_injuries.xlsx** includes reported cumulative injuries by date as reported by OCHA_oPt, who in turn reports the data is from the Palestinian Ministry of Health
